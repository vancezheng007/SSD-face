...
parser.add_argument('--dataset', default='face_300', choices=['face_512_v1', 'face_512', 'face_300'],
...
parser.add_argument('--save_folder',
                    ...
                    # default='TRAIN/' + 'face_weights_512_Adalta_' + time.strftime('%Y-%m-%d_%H-%M-%S') + '/',
                    default='TRAIN/face_weights_300_SSD/',
                    # default='face_weights_512_SGD_substract/',
                    help='Location to save checkpoint models')
parser.add_argument('--dataset_root', default='*/SSD/data/WIDER', help='Location of VOC root directory')
...
# means = (104, 111, 120)  # only support voc now
# accum_batch_size = 32
# iter_size = accum_batch_size / args.batch_size
# max_iter = args.iterations
# stepvalues = (40000, 100000, 120000)
# gamma = 0.1
# momentum = 0.9
...
def train():
    ...
    criterion = MultiBoxLoss( cfg['num_classes'], args.jaccard_threshold, True, 0, True, args.neg_pos_ratio, 0.5, False, args.cuda)
        ...
        for iteration in range(args.start_iter, args.iterations):
            ...
            if iteration % 20 == 0:
                ...
                if args.visdom and args.send_images_to_visdom:
                    ...
                    # viz.image(images.data[random_batch_index].cpu().numpy(), win='image')
                # if args.visdom:
            ...
            if iteration % 5000 == 0:
                ...
                torch.save(ssd_net.state_dict(), args.save_folder + '/ssd_300_wider_' +
                           repr(iteration) + '.pth')
    except:
        torch.save(ssd_net.state_dict(), args.save_folder + '/ssd_300_wider_' +
                   repr(iteration) + '.pth')
