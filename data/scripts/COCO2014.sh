...
if [ -z "$1" ]
  then
    # navigate to ~/data
    echo "navigating to /media/disk/Backup/ZhengFeng/ssd.pytorch/data/ ..."
    mkdir -p /media/disk/Backup/ZhengFeng/ssd.pytorch/data
    cd /media/disk/Backup/ZhengFeng/ssd.pytorch/data/
    mkdir -p ./coco
    cd ./coco
    mkdir -p ./images
    mkdir -p ./annotations
